...
export async function insertInvoiceBaseData(rawData) {
  ...
  const productsQuery = `
    INSERT INTO b7.inv_ln (
      inv_id, apply_id, nr, goods, unit_cost, unit, unit_price, qty, tax_id, descr, gtu, zw_typ, zw_basis, art100, appx15
    ) VALUES ( 
      $1, $2, $3, false, 0, $4, $5, $6, $7, $8, 0, null, null, false, false
    )
  `;
